...
export default class Framebuffer extends Resource {
    ...
    static getDefaultFramebuffer( gl ) {
        gl.poly = gl.poly || {};
        if ( !gl.poly.defaultFramebuffer ) {
            gl.poly.defaultFramebuffer = new Framebuffer( gl, { handle: null, attachments: {} } );
        }
        // TODO - can we query for and get a handle to the GL.FRONT renderbuffer?
        return gl.poly.defaultFramebuffer;
    }
    ...
    /* global window */
        if ( typeof window !== 'undefined' ) {
            window.open( this.copyToDataUrl(), 'poly-debug-texture' );
        }
        return this;
    }
