// Depends on Khronos Debug support module being imported via "poly.gl/debug"
...
export function getDebugContext( gl ) {
    ...
    if ( !global.WebGLDebug ) {
        log.warn( 'WebGL debug mode activation failed. import "poly.gl/debug" to enable.' );
        return gl;
    }
    ...
    merge( WebGLDebugContext.prototype, debugContext );
