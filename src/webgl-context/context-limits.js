...
export function getContextLimits( gl ) {
    ...
    if ( !gl.poly.limits ) {
        gl.poly.limits = {};
        gl.poly.webgl1MinLimits = {};
        gl.poly.webgl2MinLimits = {};
        ...
        ( 'extension' in limit && !gl.getExtension( limit.extension ) );
            ...
            gl.poly.limits[ parameter ] = value;
            gl.poly.webgl1MinLimits[ parameter ] = webgl1MinLimit;
            gl.poly.webgl2MinLimits[ parameter ] = webgl2MinLimit;
        }
    }

    return gl.poly.limits;
}
...
export function getContextInfo( gl ) {
    ...
    // basic information
        ...
        info,
        limits,
        webgl1MinLimits: gl.poly.webgl1MinLimits,
        webgl2MinLimits: gl.poly.webgl2MinLimits
    };
}
