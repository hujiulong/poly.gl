import formatGLSLError from 'poly.gl/webgl-utils/format-glsl-error';
...
it( 'WebGL#formatGLSLError', done => {
    const error = formatGLSLError( ERROR_LOG, SHADER_SOURCE, SHADER_TYPE );
    assert.equal( error, EXPECTED, 'formatGLSLError generated correct error' );
    done();
} );
