import { glKey, getContextInfo } from 'poly.gl';
import { TEST_EXPORTS } from 'poly.gl/webgl/context-limits';
...
it( 'WebGL1#getContextInfo#limits', done => {
    ...
    for ( const limit in TEST_EXPORTS.WEBGL_LIMITS ) {
        ...
        if ( Number.isFinite( actual ) ) {
            ...
            assert.ok( true, `${glKey( limit )}: actual limit ${actual} webgl2 limit ${webgl2}` ); // pass
        }
    }
